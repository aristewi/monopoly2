...
import edu.ncsu.monopoly.BoardGame;
...
public class GameBoardUtil {
	...
	public static List getEastCells(BoardGame board) {
	...
	public static List getNorthCells(BoardGame board) {
		Dimension d = calculateDimension(board.getCellNumber());
		int longSide = d.width;
		int shortSide = d.height;
		List cells = new ArrayList();
	...
	public static List getSouthCells(BoardGame board) {
		Dimension d = calculateDimension(board.getCellNumber());
		int longSide = d.width;
		int shortSide = d.height;
		List cells = new ArrayList();
	...
	public static List getWestCells(BoardGame board) {
		Dimension d = calculateDimension(board.getCellNumber());
		int longSide = d.width;
		int shortSide = d.height;
		List cells = new ArrayList();
